(typeof nougat !== 'undefined'  ? nougat : require('nougat')).$(
  ...
  'Inflections', function(global, nougat) {
    'use strict';
    
    var hasProp = global.hasProp || require('./hasProp');
    var remove  = global.remove || require('./remove');
    var icPart  = global.icPart || require('./icPart');
    ...
    Inflections.getInstance = function(locale) {
      var storage = typeof process !== 'undefined' ? process : nougat;
